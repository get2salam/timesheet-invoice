  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden max-w-2xl mx-auto">
      ...
      <div className="p-6">
        ...
        <p className="text-xs text-gray-500 italic mb-4">* Overtime (OT): Hours beyond {RATES.standardHours}hrs at {RATES.otRate} pounds per hour</p>
        ...
        <div className="mt-6 pt-4 border-t border-gray-200">
          ...
          <div className="bg-gray-50 rounded-lg p-3 text-sm">
            <p className="mb-1"><span className="text-gray-500">Bank: </span><span className="text-gray-800 font-medium">{COMPANY_DETAILS.bankName}</span></p>
            <p className="mb-1"><span className="text-gray-500">Account Name: </span><span className="text-gray-800 font-medium">{COMPANY_DETAILS.accountName}</span></p>
            <p className="mb-1"><span className="text-gray-500">Account Number: </span><span className="text-gray-800 font-medium">{COMPANY_DETAILS.accountNumber}</span></p>
            <p><span className="text-gray-500">Sort Code: </span><span className="text-gray-800 font-medium">{COMPANY_DETAILS.sortCode}</span></p>
          </div>
